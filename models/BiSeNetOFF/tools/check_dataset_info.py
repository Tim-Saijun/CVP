...
parse.add_argument('--im_root', dest='im_root', type=str, default='/root/YangZR/datasets/mix/imgroot',)
parse.add_argument('--im_anns', dest='im_anns', type=str, default='/root/YangZR/datasets/mix/train.txt',)
